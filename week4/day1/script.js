...
Здесь условие — это выражение, которое вычисляется в булевское значение (истина или ложь), значение_если_истина — значение, которое будет возвращено, если условие истинно, и значение_если_ложь — значение, которое будет возвращено, если условие ложно.

Пример использования оператора условного выбора:
...
console.log(message); // Вывод: "Number is not greater than 10"
